...
pub unsafe fn register_all(conn: duckdb_connection) {
    ...
    register_table_function(conn, "sequence_json", &[DataType::Binary]);
    register_table_function(
        conn,
        "spatial_index_find_in_envelope",
        &[
            DataType::Binary,
            DataType::Float64,
            DataType::Float64,
    ...
    register_table_function(
        conn,
        "spatial_index_find_within_distance",
        &[
            DataType::Binary,
            DataType::Float64,
            DataType::Float64,
    ...
    register_table_function(
        conn,
        "temporal_index_find_after",
        &[DataType::Binary, DataType::Int64],
    );
    register_table_function(
        conn,
        "temporal_index_find_at",
        &[DataType::Binary, DataType::Int64],
    );
    register_table_function(
        conn,
        "temporal_index_find_before",
        &[DataType::Binary, DataType::Int64],
    );
    register_table_function(
        conn,
        "temporal_index_find_in_range",
        &[DataType::Binary, DataType::Int64, DataType::Int64],
    );
    register_table_function(
        conn,
        "temporal_index_find_overlapping",
        &[DataType::Binary, DataType::Int64, DataType::Int64],
    );
    register_table_function(
        conn,
    ...
    register_table_function(conn, "tgeogpoint_to_rows", &[DataType::Binary]);
    register_table_function(conn, "tgeompoint3d_to_rows", &[DataType::Binary]);
    register_table_function(conn, "tgeompoint_to_rows", &[DataType::Binary]);
    register_table_function(
        conn,
        "tint_time_split",
        &[DataType::Binary, DataType::Int64, DataType::Int64],
